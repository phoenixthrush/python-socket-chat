...
def clientThread(client):
    ...
    users[client] = user
    try:
        client.send("Hi {}! You are now connected to phoenixthrush's furry chat. Type \"/help\" for a list of available commands! ".format(user).encode("utf8"))
    except:
...
def getNickname(client):
    ...
    client.send("Welcome to my chatroom! Please type your nickname:".encode("utf8"))
